...
function FacultyLayoutWrapper({ user, setUser }) {
  ...
  //   if (!currentPart || currentPart === 'faculty') return 'Dashboard';

  //   return currentPart.replace(/-/g, ' ');
  // };
    ...
    <>
      <div className="dashboard-layout d-flex min-vh-100">
        ...
        <div
          ...
          style={{
            left: 0,
            paddingLeft: isSidebarCollapsed ? "105px" : "325px", // Sidebar width + 25px padding
            paddingRight: "24px",
            height: "64px",
            zIndex: 999,
          ...
          <div className="me-auto d-flex align-items-center">
            <span className="text-dark fw-bold fs-5 text-capitalize">
              {location.pathname
                ...
                .pop()
                .replace(/-/g, " ")
                .replace("faculty", "Dashboard") || "Dashboard"}
            </span>
          </div>
...
export default function FacultyDashboardLayout({ user, setUser }) {
  return (
    <NotificationProvider user={user}>
      <FacultyLayoutWrapper user={user} setUser={setUser} />
    </NotificationProvider>
  );
}
